...
tools a task works under; a model review keeps the reviewer's prose and the
hash of the contract it judged; and `init` and `doctor` name the preconditions
the tool cannot verify. New in 0.3.0: a journal can live in a repository of its
